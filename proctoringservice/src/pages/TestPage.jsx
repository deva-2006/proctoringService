...
function TestPage() {
  ...
  const sessionId =
    searchParams.get('sessionId') || 'dummy-session-001';

  const examId =
    searchParams.get('examId') || 'exam001';

  const studentId =
    searchParams.get('studentId') || 'student001';

  const userName =
    searchParams.get('userName') || 'Gayathri';
      ...
      <main className="test-page">
        ...
        >
          ...
          >
            ...
            because you remained out of full-screen mode
    ...
    <main className="test-page">
      <section className="test-card">
        ...
        <p className="subtitle">
          This page is intentionally simple and focused
        ...
        >
          <fieldset>
            <legend>
              Which library is used to build this UI?
            </legend>
        ...
        {showConfirm && (
          <div
            className="warning-modal confirm-modal"
            role="alertdialog"
            aria-live="assertive"
          >
            <h2>Submit Exam?</h2>
        ...
        {showWarningModal && !showConfirm && (
          ...
          >
            ...
            <p>
              You left the exam window or exited
              full-screen mode.
            </p>
            ...
            <p>
              Please stay on the exam page for the
